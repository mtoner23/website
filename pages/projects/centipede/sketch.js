...
function preload() {
	mushroomImg = loadImage("centipede/images/mushroom.png");
	mushroom1Hit = loadImage("centipede/images/mushroom1Hit.png");
	mushroom2Hit = loadImage("centipede/images/mushroom2Hit.png");
	playerImg = loadImage("centipede/images/player_2x.png");
	shotImg = loadImage("centipede/images/shot.png");
	spiderImg = loadImage("centipede/images/spider.png");
	segHitImg = loadImage("centipede/images/segment_hit.png");
	segRevHitImg = loadImage("centipede/images/segment_rotate_hit.png");
	segImg = loadImage("centipede/images/segment.png");
	headImg = loadImage("centipede/images/head.png");
	headRevImg = loadImage("centipede/images/head_rotate.png");
	segRevImg = loadImage("centipede/images/segment_rotate.png");

	shotSound = loadSound("centipede/sounds/shot.wav")
	music = loadSound("centipede/sounds/music.mp3")

	font = loadFont("centipede/fonts/SourceSansPro-Regular.otf");
}
